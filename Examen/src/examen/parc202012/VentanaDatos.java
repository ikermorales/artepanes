...
public class VentanaDatos extends JInternalFrame {
	 ...
	 * @param enHilo	Si es true, se lanza en un hilo independiente, si es false se lanza con el thread de Swing
	 */
	public void addBoton( String texto, Runnable runnable, boolean enHilo ) {
		...
		b.addActionListener( new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (enHilo) (new Thread(runnable)).start();
				else runnable.run();
			}
		});
	}
