...
public class Tabla {
	...
	/** Filtra los datos de una tabla quitando los que no cumplan una condiciÃ³n
	 * @param col	Columna de consulta de la tabla
	 * @param condMantener	ExpresiÃ³n lÃ³gica que debe cumplir el valor del campo para que se MANTENGA
	 * @return	NÃºmero de filas quitadas
	 */
	...
	/** Ordena los datos de una tabla de acuerdo al valor alfabÃ©tico de una columna
	 * @param col	Columna de ordenaciÃ³n de la tabla
	 */
	...
	/** Devuelve la fila donde se encuentra el primer cÃ³digo buscado 
	 * @param codigo	CÃ³digo que se busca
	 * @param numCols	Columnas que componen el cÃ³digo (concatenadas en ese orden)
	 * @return	Fila del cÃ³digo, -1 si no se encuentra
	 */
	...
	/** Cambia una cabecera
	 * @param numCol	NÃºmero de columna a modificar
	...
	/** AÃ±ade una columna en la posiciÃ³n indicada
	 * @param header	Nuevo nombre de cabecera para la columna
	 * @param defaultValue	Valor por defecto para asignar a cada fila existente en esa nueva columna
	 */
	...
	/** AÃ±ade una lÃ­nea de datos al final de la tabla (no hace nada si la tabla es una tabla enlazada a lista)
	 ...
	 * @param prefijo	Prefijo a aÃ±adir a las cabeceras
	 ...
	 * @param row	NÃºmero de fila a eliminar
	 */
	...
	public Tabla crearTablaConCols( String... nomCol ) {
		...
		for (int i=0;i<getWidth();i++) {
			if (Arrays.asList(nomCol).contains( getHeader(i) )) {  // AÃ±ade las columnas cuyo nombre se ha indicado
				colsADejar.add( i );
			}
		}
		Tabla ret = new Tabla();
	...
	/** Devuelve una fila completa de la tabla separada por tabs y quitando saltos de lÃ­nea
	 * @param row	NÃºmero de fila
	 ...
	 * @param col	NÃºmero de columna de la tabla
	 * @return	Listado de valores, ordenado por frecuencias, con un valor por lÃ­nea en formato valor <tab> frecuencia. "" si hay cualquier error
	 */
	...
	/** Procesa un fichero csv (codificado UTF-8) y lo carga devolviÃ©ndolo en una nueva tabla
	 ...
	 * @param lineaCabs	Por defecto es 1 (nÃºmero de lÃ­nea que incluye las cabeceras) pero si es otra se puede indicar (>= 1)
	 * @return	Nuevo objeto tabla con los contenidos de ese csv
	 * @throws IOException
	...
	throws MalformedURLException,  // URL incorrecta 
	 ...
	 FileNotFoundException, // En algunos servidores, acceso a pÃ¡gina inexistente
	...
	// =================================================
	// Clases/MÃ©todos relacionados con las operaciones sobre tablas
	
	/** Clase cuyo mÃ©todo run, al ser ejecutado, copia el contenido de la tabla asociada al portapapeles
	 */
